 ...
 */
    ...
    public class Profile extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            final TextView developerUrl = (TextView) findViewById(R.id.developerUrl);


            Intent intent = getIntent();
            final String userName = intent.getStringExtra(UsersAdapter.KEY_NAME);
            final String image = intent.getStringExtra(UsersAdapter.KEY_IMAGE);
            final String profileUrl = intent.getStringExtra(UsersAdapter.KEY_URL);
